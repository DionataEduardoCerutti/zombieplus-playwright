...
export class Tvshows {
    ...
    async create({ tvshow }) {
        await this.tabTvshows()
        await this.goForm()

        //await this.page.locator('#title').fill(title)
        await this.page.getByLabel('Titulo da série').fill(tvshow.title)//label que tem o for o mesmo nome do id ou name do campo
        ...
        if (tvshow.featured) { //Se for verdadeiro entra
